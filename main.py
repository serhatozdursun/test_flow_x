...
if __name__ == '__main__':
    ...
    if conversion_type == '1':
        source_file = input(f"{YELLOW_TEXT}Enter the Postman Collection JSON file name (with .json extension): {RESET_TEXT}")
        destination_file = input(f"{YELLOW_TEXT}Enter the desired JMX file name (with .jmx extension): {RESET_TEXT}")
        ...
        destination_file = input(f"{YELLOW_TEXT}Enter the desired Postman Collection JSON file name (with .json extension): {RESET_TEXT}")
